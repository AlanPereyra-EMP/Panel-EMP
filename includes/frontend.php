...
function emp_woo_custom_product_searchform( $form ) {
	...
	$form = '<form class="woo-searchform" role="search" method="get" id="searchform" action="' . esc_url( home_url( '/'  ) ) . '">
        		<div>
        			...
        			<input class="btn" type="submit" id="searchsubmit" value="'. esc_attr__( 'Buscar', 'woocommerce' ) .'" />
